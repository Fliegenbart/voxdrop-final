...
VISION_IMAGE_MAX_EDGE = int(os.getenv("VD_VISION_IMAGE_MAX_EDGE", "768"))
VISION_RETRY_IMAGE_MAX_EDGE = int(os.getenv("VD_VISION_RETRY_IMAGE_MAX_EDGE", "512"))
...
VLM_IMAGE_MAX_EDGE = int(os.getenv("VD_VLM_IMAGE_MAX_EDGE", "768"))
VLM_CONTEXT_IMAGE_MAX_EDGE = int(os.getenv("VD_VLM_CONTEXT_IMAGE_MAX_EDGE", "384"))
VLM_RETRY_IMAGE_MAX_EDGE = int(os.getenv("VD_VLM_RETRY_IMAGE_MAX_EDGE", "512"))
